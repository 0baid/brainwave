        ...
        <Section crosses>
            <div className='container lg:flex'>
                <div className='max-w-[25rem]'>
                    <h2 className='h2 mb-4 md:mb-8'>AI chat for seamless collaborations</h2>
                ...
                <div className='lg:ml-auto xl:w-[38rem] mt-4'>
                    ...
                    <div className='relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale-25 md:scale-100'>
                        ...
                        <ul>
                            {
                                collabApps.map((item,index) => (
                                    <li className={`absolute top-0 left-1/2 h-1/2 -ml-[1.6rem] origin-bottom rotate-${index * 45}`} key={item.id}>
                                        <div className={`relative -top-[1.6rem] flex w-[3.2rem] h-[3.2rem] ng-n-7 border border-n-1/15 rounded-xl -rotate-${index * 45}`}>
                                            <img
                                                className='m-auto'
                                                height={item.height}
                                                width={item.width}
